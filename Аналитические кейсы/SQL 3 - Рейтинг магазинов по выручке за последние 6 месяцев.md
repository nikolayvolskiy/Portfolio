...
SELECT 
    ...
    unique_customers,
    -- Средний чек
    ROUND(total_revenue * 1.0 / transaction_count, 2) as avg_check,
    -- Среднее количество товаров в чеке
    ROUND(total_items_sold * 1.0 / transaction_count, 2) as avg_items_per_check,
    -- Выручка на клиента
    ROUND(total_revenue * 1.0 / unique_customers, 2) as revenue_per_customer,
